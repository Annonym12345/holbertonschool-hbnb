// HBnB Part 4 - Login Page JavaScript (TASK 1)
// Author: Holberton School Project
// Description: Handle login form submission and authentication
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (event) => {
            ...
            submitButton.innerHTML = `
                <div class="spinner" style="width: 20px; height: 20px; margin: 0 auto; border: 2px solid rgba(255,255,255,0.3); border-top-color: white; border-radius: 50%; animation: spin 0.6s linear infinite;"></div>
            `;
            ...
            try {
                ...
                if (response.ok) {
                    // Login successful
                    // Store JWT token in cookie (7 days expiration)
